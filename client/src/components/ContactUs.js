  ...
  <Container>
    <Row>
      <Col>
          ...
          <p class="text-center"><a href="https://www.instagram.com/redcatandco/"><img src={require('../assets/images/Instagram.png')} width="9%" height="9%" alt="Instagram Logo" /></a> <a href="https://www.facebook.com/redcatandco/"><img src={require('../assets/images/facebooklogo.png')} width="9%" height="9%" alt="Facebook Logo" /></a> <Mailto email="jessica@redcatandco.com" subject="General Inquiry" body="I'd like to ask about ..."><img src={require('../assets/images/email.png')} width="10%" height="10%" alt="Email Me" /></Mailto></p>
      </Col>
    </Row>
  </Container>
)